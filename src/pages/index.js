    ...
    <Layout>
      ...
      <AnimatePresence>
        ...
        >
          ...
          <Accordion>
            <Container bordered>
              <YearTitle onClick={() => setCollapsed([1, 0, 0, 0])}>
              ...
              <YearGallery>
                {slides2020.edges.map((s, ndx) => {
                  return (
                    ...
                    >
                      <Img fluid={s.node.childImageSharp.fluid} />
                    </div>
                  );
                })}
              </YearGallery>
            ...
            <Collapsed hide={collapsed[0]}>
              <Container bordered>
                <YearPoster>
                  <Img fluid={posters[2].node.childImageSharp.fluid} />
                </YearPoster>
                <YearDescription>
                  ...
                  Renks, Solid Angle, e.Gest, Ptzoid, S.Friedt. Рокешник от
                  R.A.W.S. И, возможно, такого вы больше никогда не увидите, а
                  те, кто видел, будут рассказывать своим детям: группа ТРОЯР!
                  Год был богат на крупные коллаборации. Специально для Reverse
                  Side of The Road 2020 пивоварня Paradox сварила смородиновое
                  гозе, Гоша Орехов сделал партию сумок с нашим дизайном, а
                  Russian Raketa – стильные колеса и звезды. Гонку поддержали
                  Specialized и CityCycle Moscow, была выпущена большая партия
                  фляг Purist с символикой RSRS. Уже не первый год за дизайн в
                  рамках коллабораций и айдентику гонки отвечает студия SHOPLIFT
                  DESIGN. Есть такое выражение: brother from another mother – и
                  это как раз про гонку и SHOPLIFT DESIGN. Лучшее сотрудничество
                  за всю нашу историю.
                </YearDescription>
              </Container>
              <YearFact bordered>
          ...
          <Accordion>
            <Container bordered>
              <YearTitle onClick={() => setCollapsed([0, 1, 0, 0])}>
                <p className="year__wrapper">
            ...
            <Collapsed hide={collapsed[1]}>
              <Container bordered>
                <YearPoster>
                  <Img fluid={posters[3].node.childImageSharp.fluid} />
                </YearPoster>
              ...
              <YearFact bordered>
                ...
                <div className="fact__col-2">
                  <ul className="fact__list" style={{ marginBottom: "50px" }}>
                    <li>1. Екатерина Борилкевич</li>
                    <li>2. Мария Ройтман</li>
                    <li>3. Александра Маскова</li>
                  </ul>
                  <ul className="fact__list" style={{ marginBottom: "70px" }}>
          ...
          {/* YEAR 2018 */}
          <Accordion maxHeight={292}>
            <Container bordered>
              <YearTitle onClick={() => setCollapsed([0, 0, 1, 0])}>
                <p className="year__wrapper">
                  o. vetrennoye <br />
            ...
            <Collapsed hide={collapsed[2]}>
              <Container bordered>
                <YearPoster>
                  <Img fluid={posters[1].node.childImageSharp.fluid} />
                </YearPoster>
                <YearDescription>
          ...
          <Accordion>
            <Container bordered>
              <YearTitle onClick={() => setCollapsed([0, 0, 0, 1])}>
                <p className="year__wrapper">
                  o. vetrennoye
                  <br />
            ...
            <Collapsed hide={collapsed[3]}>
              <Container bordered className={collapsed[3] ? null : "hide"}>
                <YearPoster>
                  <Img fluid={posters[0].node.childImageSharp.fluid} />
                </YearPoster>
                <YearDescription>
