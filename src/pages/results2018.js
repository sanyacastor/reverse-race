...
import JSONMulti from "../JSONData/ResultsMulti18.json";
import JSONAll from "../JSONData/ResultsOther18.json";
    ...
    <Layout>
      ...
      <AnimatePresence>
        {visible && (
          ...
          >
            <ResultsContainer>
              <Header2>РЕзультаты 2018</Header2>
              <Category header="Мультиспид муж." users={JSONMulti} />
              <Category header="Мультиспид Жен." users={JSONAll.singleW} />
