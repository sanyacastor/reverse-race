      ...
      <FaqContainer id="faq">
        ...
        <div className="text">
          ...
          <Text>
            ...
            ровно столько, сколько способны прибрать за собой. Картинка про
            таких идиотов приложена внизу, не будьте свиньями. Мусор – это не
            чья-то размытая обязанность, это личная ответственность каждого, кто
            приехал! За мат извини, я в другом лагере.
          </Text>
          ...
          <Text>
            ...
            <br />
            22:30 – Разговор с Владимиром Птичниковым из “Ракета” и презентация
            нашей коллаборации
            <br />
            22:45 – Разговор с Дмитрием Поповым о “Гришка Гир” и байкпакинге
            <br />
          ...
          <a href="./gpx/RevrerseS.gpx" download>
            скачать
          </a>
          <br />
          ...
          <a href="./gpx/RevrerseB.gpx" download>
            скачать
          </a>
          ...
          <br />
          <Accent>3 пункт питания</Accent> – 109км маршрута.Осторожнее выезжайте
          с пункта питания, там пересечение с шоссе.
          <Text>
          ...
          <Text>
            ...
            районе “Злотой Долины”, немного передохнув, оттуда вы достаточно
